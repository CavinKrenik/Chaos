...
const PROJECTS = [
  ...
  },
  {
    id: 'dropfizz',
    title: 'DropFizzers',
    description: 'A custom-built online store for my sister\'s business, DropFizz. This is a React application designed to sell eco-friendly cleaning tablets. It handles everything from showcasing products like the "Holiday Kit" to processing payments via Stripe and managing customer inquiries through Formspree.',
